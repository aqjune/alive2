...
nocapture %s, i64 %call, i64 %call1, i8* %res) nounwind uwtable {
entry:
  %add = add i64 %call, 1
...
return:                                           ; preds = %if.end, %entry
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %res, i8* %call4, i64 %add3, i32 1, i1 false)
  ret void
}

define fastcc void @tgt(i8* nocapture %name, i8* nocapture %domain, i8** nocapture %s, i64 %call, i64 %call1, i8* %res) nounwind uwtable {
entry:
  %add = add i64 %call, 1
  %add2 = add i64 %add, %call1
  %add3 = add i64 %add2, 1
